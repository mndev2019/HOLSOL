  ...
  return (
    <>
      <section className='relative  px-8 py-10 bg-gradient-to-br from-[#f8fbff] to-[#eef7ff] overflow-hidden'>
        ...
        {
          data.map((blog, index) => {
            const { day, month, year } = getDateParts(blog.createdAt);
            return (
              <div
                key={blog.id}
              ...
              >
                {/* Image Section */}
                <div
                  className={`lg:col-span-4 col-span-1 ${index % 2 === 1 ? "lg:order-2" : "lg:order-1"
                    }`}
                >
                ...
                {/* Content Section */}
                <div
                  className={`lg:col-span-8 col-span-1 ${index % 2 === 1 ? "lg:order-1" : "lg:order-2"
                    }`}
                >
