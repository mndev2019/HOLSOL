...
const Presence = () => {
  ...
  return (
    <section className="relative lg:px-20 px-5 lg:py-16 py-10 bg-gradient-to-r from-[#f8fbff] to-[#e9f3ff]">
      <Heading title="Best Solar Energy Solutions" />
      <h3 className="text-[2em] font-[700] text-[#192e5b] py-3 ">
        Our Presence
      </h3>

      <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 items-center mt-6">
        {/* Left side - Addresses */}
        <div className="grid sm:grid-cols-1 gap-6">
          {offices.map((office, index) => (
            <div
              key={index}
              className="flex gap-4 p-5 rounded-2xl bg-white/70 backdrop-blur-md shadow-md border border-gray-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
            >
              <div className="flex-shrink-0 text-[var(--primary)] text-3xl bg-[#e6f0ff] p-4 rounded-xl shadow-inner">
                <FaHome />
              </div>
              <div>
                <h4 className="font-semibold text-lg text-[#192e5b]">
                  {office.title}
                </h4>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {office.address}
        ...
        {/* Right side - Map */}
        <div className="relative w-full h-[450px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.245217806453!2d75.73235777525845!3d26.861119576690184!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db57add311b17%3A0x7039970c4300422b!2sRS%20group!5e0!3m2!1sen!2sin!4v1726069584863!5m2!1sen!2sin"
            width="100%"
            height="100%"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#192e5b]/10 to-transparent pointer-events-none"></div>
        </div>
      </div>
    </section>
  );
