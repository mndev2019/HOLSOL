...
const Services = () => {
    const service = [
    {
      ...
      para: "At Suntek Solar, we are dedicated to providing cutting-edge industrial rooftop solar power solutions that help industries harness the power of the sun."
    },
    {
      image: reseential,
      icon: <FaHome className="w-6 h-6" />,
      title: "Residential Rooftops",
      para: "At Suntek Solar, we are dedicated to providing clean and reliable solar solutions for homes, ensuring energy independence and long-term savings."
    },
    {
      image: commercial,
      icon: <MdBusiness className="w-6 h-6" />,
      title: "Commercial Rooftops",
      para: "At Suntek Solar, we are helping businesses go green with advanced commercial rooftop solutions that reduce costs and enhance sustainability."
    }
  ]
    return (
        <>
            <section className='lg:px-20 px-5 lg:py-10 py-5'>
                ...
                <p className='text-[15px] tracking-wide'>
                    Established in 2008, Suntek Energy Systems Private Limited is a Trusted solar energy company in India, specializing in Residential, Commercial, Industrial and Ground-mounted Solar installations. Our comprehensive portfolio includes advanced Rooftop Solar Systems and Large-Scale Solar Power Plants
                </p>
