...
const Bannermobile = () => {
  ...
  return (
    <>
      <section className="relative h-[100vh] w-full overflow-hidden md:hidden block">
            ...
            <div key={index} className="relative  h-[100vh]">
              ...
              >
                ...
                <div className="relative z-10 text-left text-white max-w-3xl px-8 md:px-16 md:py-0 py-10">
                  <h1 className={`text-2xl  md:text-5xl font-bold leading-tight md:mb-6 mb-4 ${index === 2 ? "sm:text-[#6c4d47] text-white" : "text-white"}`}>
                    {s.title} <br />
